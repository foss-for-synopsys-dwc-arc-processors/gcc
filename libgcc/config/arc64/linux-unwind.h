...
enum registers_stack_order {
  ...
  #include "config/arc64/linux-unwind-reg.def"
...
#define REGISTER_SIZE_IN_WORDS 8
...
/*
000000000002fca8 <__default_rt_sa_restorer>:
   2fca8:	208a 12c2           	mov	r8,139
   2fcac:	781e                	trap_s	0
   2fcae:	7ee0                	j_s	[blink]
*/
			   ...
			   _Unwind_FrameState *fs)
{
  ...
  u_int64_t *pc = (u_int64_t *) context->ra;

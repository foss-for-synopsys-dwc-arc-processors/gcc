...
(define_insn "*movqi_insn"
  [(set (match_operand:QI 0 "move_dest_operand" "=Rcq,Rcq#q,    w,   c, w, w,???w, w,Rcq,  S,!*x,r,m,???m")
	(match_operand:QI 1 "move_src_operand"   " cL,   cP,Rcq#q,cCm1,cL, I,?Rac,?i,  T,Rcq,Usd,m,c,?Rac"))]
...
(define_insn "*movhi_insn"
  [(set (match_operand:HI 0 "move_dest_operand" "=Rcq,Rcq#q,    w,   c, w,w,???w,Rcq#q,w,Rcq,  S,r,m,???m,VUsc")
	(match_operand:HI 1 "move_src_operand"    "cL,   cP,Rcq#q,cCm1,cL,I,?Rac,  ?i,?i,  T,Rcq,m,c,?Rac,   i"))]
...
(define_insn "*movsi_insn"
  [(set (match_operand:SI 0 "move_dest_operand"  "=Rcq,Rcq#q,    w,   c, w,w,  w,???w, ?w,  w,Rcq#q,   w,Rcq,  S,   Us<,RcqRck,!*x,Rsd,Rcd,r,m,???m,VUsc,VUsc")
	(match_operand:SI 1 "move_src_operand"     "cL,   cP,Rcq#q,cCm1,cL,I,Crr,?Rac,Cpc,Clb, ?Cal,?Cal,  T,Rcq,RcqRck,   Us>,Usd,Usd,Ucd,m,c,?Rac, Cm3,C32"))]
   ...
   * return arc_short_long (insn, \"pop%? %0%&\",  \"ld%U1 %0,%1%&\");
   ...
   st%U0%V0 %1,%0       ;22
   st%U0%V0 %S1,%0      ;23"
  [(set_attr "type" "move,move,move,move,move,move,two_cycle_core,move,binary,binary,move,move,load,store,store,load,load,load,load,load,store,store,store,store")
   (set_attr "iscompact" "maybe,maybe,maybe,true,false,false,false,false,false,false,maybe_limm,false,true,true,true,true,true,true,true,false,false,false,false,false")
   ; Use default length for iscompact to allow for COND_EXEC.  But set length
   ; of Crr to 4.
   (set_attr "length" "*,*,*,*,4,4,4,4,8,8,*,8,*,*,*,*,*,*,*,*,*,*,4,8")
   (set_attr "predicable" "yes,no,yes,no,yes,no,no,yes,no,no,yes,yes,no,no,no,no,no,no,no,no,no,no,no,no")
   (set_attr "cpu_facility" "*,*,arcv1,em,*,*,*,*,*,*,*,*,*,*,*,*,*,cd,cd,*,*,*,em,*")
   ])
...
(define_insn_and_split "*addsi3_mixed"
  ...
  [(set (match_operand:SI 0 "dest_reg_operand"          "=Rcq#q,Rcq,   c,Rcw,Rcw,Rcq,Rcb,Rcq, Rcw, Rcqq,Rcqq,    W,  W,W,  W,Rcqq,Rcw,  W")
...
(define_insn "cmpsi_cc_insn_mixed"
  [(set (reg:CC CC_REG)
	(compare:CC (match_operand:SI 0 "register_operand"  "Rcq#q,  c, c, c, qRcq, c")
...
(define_insn "*cmpsi_cc_c_insn"
  [(set (reg:CC_C CC_REG)
	(compare:CC_C (match_operand:SI 0 "register_operand"  "Rcqq,  c, c,Rcqq,  c")

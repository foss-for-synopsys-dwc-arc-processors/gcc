...
END {
    ...
    print "MULTILIB_MATCHES += mcpu?arcem=mEM"
    print "MULTILIB_MATCHES += mcpu?arcem=mARCv2EM"
    print "MULTILIB_MATCHES += mcpu?arcem=mav2em"
    print "MULTILIB_MATCHES += mcpu?arcem=marcem"
    print "MULTILIB_MATCHES += mcpu?archs=mHS"
    print "MULTILIB_MATCHES += mcpu?archs=mARCv2HS"
    print "MULTILIB_MATCHES += mcpu?archs=mav2hs"
    print "MULTILIB_MATCHES += mcpu?archs=marchs"
}

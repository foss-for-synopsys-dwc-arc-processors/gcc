...
(define_insn_reservation "data_load" 3
  ...
  "issue+dmp, dmp_write_port, dmp_write_port")
...
(define_insn_reservation "data_store" 3
  (and (eq_attr "tune_arc700" "true")
       (eq_attr "type" "store")
       (not (match_operand:DI 0 "" "")))
  "issue+dmp_write_port, dmp_write_port, dmp_write_port")

(define_bypass 3 "data_store" "data_load" "arc_store_addr_hazard_p")
;;(define_bypass 1 "data_store" "core_insn_DI")
;;(define_bypass 1 "data_store" "lr")
;;(define_bypass 1 "data_store" "sr")
;;(define_bypass 1 "data_store" "core_insn")
;;(define_bypass 1 "data_store" "cmove")
;;(define_bypass 1 "data_store" "cc_arith")
;;(define_bypass 1 "data_store" "two_cycle_core_insn")
;;(define_bypass 1 "data_store" "core_insn_DI")
;;(define_bypass 1 "data_store" "divaw_insn")
;;(define_bypass 1 "data_store" "shift_insn")
;;(define_bypass 1 "data_store" "compare_700")
;;(define_bypass 1 "data_store" "branch_700")
;;(define_bypass 1 "data_store" "multi_DI")
;;(define_bypass 1 "data_store" "umulti_DI")
;;(define_bypass 1 "data_store" "core_insn_DI")

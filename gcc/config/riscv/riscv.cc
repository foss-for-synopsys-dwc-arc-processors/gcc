...
static const struct riscv_tune_param thead_rmx100_tune_info = {
  {COSTS_N_INSNS (2), COSTS_N_INSNS (2)},	/* fp_add */
...
static const struct riscv_tune_param thead_rmx500_tune_info = {
  {COSTS_N_INSNS (2), COSTS_N_INSNS (2)},	/* fp_add */
  {COSTS_N_INSNS (2), COSTS_N_INSNS (2)},	/* fp_mul */
  {COSTS_N_INSNS (17), COSTS_N_INSNS (17)},	/* fp_div */
  {COSTS_N_INSNS (2), COSTS_N_INSNS (2)},	/* int_mul */
...
static const struct riscv_tune_param thead_rhx_tune_info = {
  {COSTS_N_INSNS (4), COSTS_N_INSNS (5)},	/* fp_add */
  {COSTS_N_INSNS (4), COSTS_N_INSNS (5)},	/* fp_mul */
  {COSTS_N_INSNS (20), COSTS_N_INSNS (20)},	/* fp_div */
  {COSTS_N_INSNS (1), COSTS_N_INSNS (1)},	/* int_mul */
...
arcv_macro_fusion_pair_p (rtx_insn *prev, rtx_insn *curr)
{
  ...
  if (get_attr_type (prev) == TYPE_MOVE
      ...
      && get_attr_move_type (curr) == MOVE_TYPE_LOAD)
    {
  ...
  if (get_attr_type (prev) == TYPE_MOVE
      && get_attr_move_type (prev) == MOVE_TYPE_STORE
      && get_attr_type (curr) == TYPE_MOVE
  ...
  if (get_attr_type (prev) == TYPE_MOVE
      ...
      && get_attr_type (curr) == TYPE_MOVE
      && get_attr_move_type (curr) == MOVE_TYPE_STORE
      && (REG_P (SET_SRC (curr_set)) && SET_DEST (prev_set) == SET_SRC (curr_set)
